...
export const mainListItems = (
  ...
  <div>
    ...
    >
      ...
      <ListItemText primary={<Typography style={{ color: "#ff6200" }}>Home</Typography>} />
    </ListItem>
    <ListItem
      button
      // @ts-ignore
    ...
    >
      ...
      <ListItemText primary={<Typography style={{ color: "#ff6200" }}>My Account</Typography>} />
    </ListItem>
    <ListItem
      button
      // @ts-ignore
    ...
    >
      ...
      <ListItemText primary={<Typography style={{ color: "#ff6200" }}>Bank Accounts</Typography>} />
    </ListItem>
    <ListItem
      button
      // @ts-ignore
    ...
    >
      ...
      <ListItemText primary={<Typography style={{ color: "#ff6200" }}>Notifications</Typography>} />
    </ListItem>
  </div>
);
...
export const secondaryListItems = (signOutPending: Function) => (
  <div>
    <ListItem button onClick={() => signOutPending()} data-test="sidenav-signout">
      ...
      <ListItemText primary={<Typography style={{ color: "#ff6200" }}>Logout</Typography>} />
    </ListItem>
  </div>
);
